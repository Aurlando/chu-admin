        ...
        icon: (
            ...
            >
                <path
                    ...
                    d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6 cursor-pointer"
                />
            </svg>
        ),
    },
    ...
    return (
        ...
        `}
            >
                {/* ── En-tête logo ── */}
                <div
                    className={`relative flex items-center border-b h-14.25 ${dark ? "border-white/5" : "border-slate-200"} ${collapsed ? "justify-center px-3" : "justify-between px-4"}`}
                >
                    <div className="flex items-center gap-3 overflow-hidden">
                        ...
                        {!collapsed && (
                            <div className="min-w-0">
                                <div
                                    className={`text-sm font-bold whitespace-nowrap ${logoText}`}
                                >
                                    HIS Admin
                                </div>
                                <div
                                    className={`text-[10px] whitespace-nowrap ${logoSub}`}
                                >
                                    Système Hospitalier
                                </div>
                            </div>
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`
                  w-full flex items-center rounded-xl text-sm transition-all duration-200 text-left border cursor-pointer
                ...
                <div
                    className={`border-t ${dark ? "border-white/5" : "border-slate-200"} ${collapsed ? "p-2 flex flex-col items-center gap-2" : "p-3 space-y-2"}`}
                >
                    {!collapsed ? (
                        <>
                            {/* Carte utilisateur */}
                            <div
                                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl ${userBg}`}
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div
                                        className={`text-xs font-medium truncate ${userName}`}
                                    >
                                        Administrateur
                                    </div>
                                    <div
                                        className={`text-[10px] truncate ${userSub}`}
                                    >
                                        CHU Anosiala
                                    </div>
                                </div>
                  ...
                  transition-all duration-200 border group cursor-pointer
                  ${
                      dark
