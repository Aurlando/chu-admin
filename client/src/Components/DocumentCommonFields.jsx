/**
 * DocumentCommonFields — les 3 champs partagés par TOUS les documents :
 * numéro de référence, date de délivrance, signataire.
 *
 * Extrait de l'ancien CertificatAdminForm pour être réutilisé par
 * n'importe quel type de document via DocumentForm.jsx.
 *
 * Props :
 *   fields      {object}    — { numero, date_delivrance, signataire }
 *   onChange    {function}  — (key, value) => void
 *   dark        {boolean}
 */
export default function DocumentCommonFields({ fields, onChange, dark }) {
